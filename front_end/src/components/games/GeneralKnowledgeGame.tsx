...
const topicQuestions: Record<string, Question[]> = {
  ...
  History: [
    ...
    },
    {
      ...
      options: ['Christopher Columbus', 'Marco Polo', 'Vasco da Gama', 'James Cook'],
      answer: 0,
    },
    {
...
export function GeneralKnowledgeGame({ topic, onGameComplete }: GameProps) {
  ...
  if (questions.length === 0) {
    return <div className="text-center text-gray-500">No questions available for this topic.</div>;
  }
  ...
  if (showResult) {
    return (
      <div className="flex flex-col items-center justify-center min-h-[70vh] relative">
        ...
        <button onClick={onGameComplete} className="rounded bg-green-600 text-white px-6 py-2 font-semibold hover:bg-green-700">Finish</button>
      </div>
    );
  }
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[70vh] relative">
      ...
      {q ? (
        <>
          <h3 className="text-xl font-semibold mb-6 text-center max-w-xl">{q.question}</h3>
